...
import kromasol from "@/public/logo_kroma.png";
    ...
    <div className={cn("flex space-x-4", className)}>
      {items.map((item, idx) => (
        <a
          ...
          href={item.link}
          onClick={onItemClick}
          className="relative flex items-center justify-center p-2 text-neutral-300 transition duration-200 hover:text-neutral-500"
        >
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <Image src={kromasol} alt="logo" height={30} />
    </a>
  );
};
